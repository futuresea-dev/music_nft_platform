globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { promises, mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1 } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/ofetch/dist/node.mjs';
import destr from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/scule/dist/index.mjs';
import { klona } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/radix3/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve } from 'file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/node_modules/pathe/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\39_bitsong.io\\source\\Lock-Song-Nuxt-vuetify-web3","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\39_bitsong.io\\source\\Lock-Song-Nuxt-vuetify-web3\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\39_bitsong.io\\source\\Lock-Song-Nuxt-vuetify-web3\\_nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\39_bitsong.io\\source\\Lock-Song-Nuxt-vuetify-web3\\_nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_zJ6ezj = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_zJ6ezj, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_zJ6ezj, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/_nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://F:/39_bitsong.io/source/Lock-Song-Nuxt-vuetify-web3/_nuxt/dist/server/server.mjs').then((r) => r.default || r);
